  ...
  const getActivityIcon = (type) => {
    switch (type) {
      ...
      case "ticket_purchased":
        return <Ticket className="h-3.5 w-3.5 text-amber-600" />;
      case "payment_completed":
        return <CreditCard className="h-3.5 w-3.5 text-emerald-600" />;
      case "organizer_suspended":
        return <UserX className="h-3.5 w-3.5 text-rose-600" />;
          ...
          {activities.map((item) => (
            ...
            >
              ...
              <div className="relative shrink-0">
                ...
                <div className="absolute -bottom-1 -right-1 p-0.5 bg-white rounded-full border border-slate-200 shadow-2xs">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-semibold text-slate-900 leading-snug">
                  ...
                  {item.target && (
                    <span className="font-semibold text-indigo-600 truncate block sm:inline">
                      {item.target}
                    </span>
                  )}
                </p>
